...
## Files
- `PR_EXT_credentials.js` — all logic, UI, storage. Self-contained.
- `PR_EXT_credentials.html` — standalone page (use as popup or options page)
...
In `PR_EXT_credentials.js`, find the relevant section template and add a field. Then add to:
